...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/balance/pay", middleware.CriticalRateLimit(), controller.SubscriptionPayBalance)
		}
		...
		enterpriseCdkRoute := apiRouter.Group("/enterprise/cdk")
		enterpriseCdkRoute.Use(middleware.UserAuth())
		{
			enterpriseCdkRoute.GET("/permission", controller.EnterpriseCdkPermission)
			enterpriseCdkRoute.GET("/balance", controller.EnterpriseCdkBalance)
			enterpriseCdkRoute.GET("/balance/logs", controller.EnterpriseCdkBalanceLogs)
			enterpriseCdkRoute.GET("/batches", controller.EnterpriseCdkBatches)
			enterpriseCdkRoute.POST("/batches", controller.CreateEnterpriseCdkBatch)
			enterpriseCdkRoute.GET("/batches/:id", controller.EnterpriseCdkBatchDetail)
			enterpriseCdkRoute.POST("/export", controller.EnterpriseCdkExport)
			enterpriseCdkRoute.POST("/copy-unused-log", controller.EnterpriseCdkCopyUnusedLog)
		}
		enterpriseAdminRoute := apiRouter.Group("/admin/enterprise")
		enterpriseAdminRoute.Use(middleware.AdminAuth())
		{
			enterpriseAdminRoute.GET("/whitelist", controller.AdminGetEnterpriseCdkWhitelist)
			enterpriseAdminRoute.PUT("/whitelist", controller.AdminUpdateEnterpriseCdkWhitelist)
			enterpriseAdminRoute.PUT("/whitelist/:user_id/limit", controller.AdminUpdateEnterpriseCdkWhitelistLimit)
			enterpriseAdminRoute.GET("/users/:user_id", controller.AdminGetEnterpriseCdkUserDetail)
			enterpriseAdminRoute.GET("/balance/:user_id", controller.AdminGetEnterpriseCdkBalance)
			enterpriseAdminRoute.POST("/balance/adjust", controller.AdminAdjustEnterpriseCdkBalance)
			enterpriseAdminRoute.GET("/balance/logs", controller.AdminGetEnterpriseCdkBalanceLogs)
			enterpriseAdminRoute.GET("/batches", controller.AdminGetEnterpriseCdkBatches)
			enterpriseAdminRoute.GET("/codes", controller.AdminGetEnterpriseCdkCodes)
			enterpriseAdminRoute.PUT("/codes/:id/disable", controller.AdminDisableEnterpriseCdkCode)
			enterpriseAdminRoute.POST("/codes/recycle", controller.AdminRecycleEnterpriseCdkCodes)
			enterpriseAdminRoute.GET("/operation/logs", controller.AdminGetEnterpriseCdkOperationLogs)
			enterpriseAdminRoute.POST("/export", controller.AdminEnterpriseCdkExport)
		}
