...
const (
	EnterpriseCdkContactMessageOptionKey = "EnterpriseCdkContactMessage"
	EnterpriseCdkContactMessageDefault   = "余额不足。如需充值，请联系管理员线下收款后授信。"
)
...
func InitOptionMap() {
	...
	common.OptionMap["ImageResolutionChannelPrice"] = ratio_setting.ImageResolutionChannelPrice2JSONString()
	...
	common.OptionMap[EnterpriseCdkContactMessageOptionKey] = EnterpriseCdkContactMessageDefault
	//common.OptionMap["ChatLink"] = common.ChatLink
	//common.OptionMap["ChatLink2"] = common.ChatLink2
	common.OptionMap["QuotaPerUnit"] = strconv.FormatFloat(common.QuotaPerUnit, 'f', -1, 64)
	common.OptionMap["RetryTimes"] = strconv.Itoa(common.RetryTimes)
	common.OptionMap["ChannelBalanceAutoRefreshMinutes"] = "0"
	common.OptionMap[ChannelMonitorEnabledOptionKey] = "true"
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ImageResolutionChannelPrice":
		err = ratio_setting.UpdateImageResolutionChannelPriceByJSONString(value)
	case "CacheRatio":
