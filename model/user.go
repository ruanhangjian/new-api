...
type User struct {
	...
	EnterpriseCdkQuota int            `json:"enterprise_cdk_quota" gorm:"type:bigint;default:0;column:enterprise_cdk_quota"`
...
func (user *User) TransferAffQuotaToQuota(quota int) error {
	// 检查quota是否小于最小额度
	minTransferQuota := common.GetMinAffiliateTransferQuota()
